...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-snippets/>
    <triggers>
      <trigger name="Trigger1" definition="MigIAhIUCgdrZXljb2RlEglWS19SRVRVUk4SDgoJbW9kaWZpZXJzEgEwOjAKJDU0NDBiMGZiLWE0ZWEtMzU1OC05NTNkLWIzZTE3YTFhYTczMBIIVHJpZ2dlcjE="/>
    </triggers>
    <typed-variables/>
    <global-variables/>
    <parameters/>
          ...
          <property name="remoteHubReferences" class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReferences">
            <object class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReference" serializationversion="1">
              <property name="reference" class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReference$TriggerReference">
                <property name="deviceName" class="String">Trigger1</property>
              </property>
            </object>
          </property>
