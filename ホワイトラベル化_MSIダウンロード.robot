...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <tags/>
    <referenced-types>
      <type name="ホワイトラベルソフトウェア名"/>
    </referenced-types>
    <referenced-snippets/>
    <triggers/>
    <typed-variables>
      <typed-variable name="softwareName" type-name="ホワイトラベルソフトウェア名"/>
    </typed-variables>
    <global-variables/>
    <parameters/>
    <return-variables/>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String">softwareName</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">ホワイトラベルソフトウェア名</property>
        </property>
      </property>
    </object>
  </property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="3">
        <property name="name" class="String">ダウンロード_x32</property>
            ...
            <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
              <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String">softwareName.basicName</property>
                </property>
              </property>
            </object>
            <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
              <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String">softwareName.Version</property>
                </property>
              </property>
            </object>
            <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
              <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String">softwareName.dsName</property>
                </property>
              </property>
            </object>
            <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
              <property name="inputValueExpression" class="kapow.robot.plugin.common.support.expression.multipletype.ComplexVariableAllowedVariableExpression" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String">softwareName.daName</property>
                </property>
              </property>
            </object>
          </property>
          <property name="remoteHubReferences" class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReferences">
            <object class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReference" serializationversion="1">
              <property name="reference" class="kapow.robot.plugin.common.stepaction.rl2.RemoteHubReference$StaticReference">
                <property name="deviceName" class="String">label1</property>
              </property>
            </object>
          </property>
        ...
        "steps": [{
          ...
          "gizmo":{
            ...
            "uri": {
              ...
              "gizmo":{
                "text": { "string": "https:\/\/rpa-g.app.box.com\/folder\/0" }
              }
            }
          }
        },
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "Input '10.3.0.9'" }
                      }
                    },
                    "comment": {
                      "meta":{
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "text": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=dsName + Version + \"_x32.msi\"" }
                                  }
                                }
                              }
                            },
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "DS_x32ダウンロード" }
              }
            },
            "comment": {
              "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"リンク &gt; テキスト[name=\\\"\"+dsName + Version + \"_x32.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"項目[name*=\\\"\"+dsName + Version + \"_x32.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "メニュー項目[name=\"ダウンロード\"]" }
                                      }
                                    }
                                  }
                                }
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "text": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=daName + Version + \"_x32.msi\"" }
                                  }
                                }
                              }
                            },
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "DA_x32ダウンロード" }
              }
            },
            "comment": {
              "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"リンク &gt; テキスト[name=\\\"\"+daName + Version + \"_x32.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"項目[name*=\\\"\"+daName + Version + \"_x32.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "text": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=basicName + Version + \"_x32.msi\"" }
                                  }
                                }
                              }
                            },
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Basic_x32ダウンロード" }
              }
            },
            "comment": {
              "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"リンク &gt; テキスト[name=\\\"\"+basicName + Version + \"_x32.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"項目[name*=\\\"\"+basicName + Version + \"_x32.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "text": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=dsName + Version + \"_x64.msi\"" }
                                  }
                                }
                              }
                            },
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "DS_x64ダウンロード" }
              }
            },
            "comment": {
              "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"リンク &gt; テキスト[name=\\\"\"+dsName + Version + \"_x64.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"項目[name*=\\\"\"+daName + Version + \"_x64.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "text": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=basicName + Version + \"_x64.msi\"" }
                                  }
                                }
                              }
                            },
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Basic_x64ダウンロード" }
              }
            },
            "comment": {
              "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"リンク &gt; テキスト[name=\\\"\"+basicName + Version + \"_x64.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"項目[name*=\\\"\"+basicName + Version + \"_x64.msi\\\"]\"" }
                                      }
                                    }
                                  }
                                }
